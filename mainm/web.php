...
<!--<script>function fuckyou(){
     ...
     window.location="http://www.eb89.com/"; //将当前窗口跳转置空白页
}
  function ck() {
    console.profile();
    console.profileEnd();
   ...
   alert(dom.src);
    ...
    <div class="menui">
      ...
      <a style=" padding: 0px 20px; " class="btn btn-lg red" href="../soduku/"  >数独游戏</a>
                  <a style=" padding: 0px 20px; " class="btn btn-lg ju" href="https://chvin.github.io/react-tetris/?lan=zh"  >俄罗斯方块</a>
                  <a style=" padding: 0px 20px; " class="btn btn-lg green" href="../light/"  >炫酷光影</a>
	 </div>
    <div class="menuii">
      <a style=" padding: 0px 20px; " class="btn btn-lg bai" href="../souces/"  >资源下载（持续更新）</a>
	 </div>
  </div>
  <span class="copyright">Copyright (c) 2021 wjmas. 部分内容来自网络</span>
        <script type="text/javascript">
        var S = {
                init: function () {
                    S.Drawing.init('.canvas');
                    document.body.classList.add('body--ready');
                    S.UI.simulate("欢迎来到|WJMAS|我为自己|代言|#countdown 3");					
